...
#define OLED_W_D0(x)		GPIO_WriteBit(GPIOA, CLK_Pin, (BitAction)(x))
#define OLED_W_D1(x)		GPIO_WriteBit(GPIOA, MOSI_Pin, (BitAction)(x))
#define OLED_W_RES(x)		GPIO_WriteBit(GPIOA, GPIO_Pin_7, (BitAction)(x))
#define OLED_W_DC(x)		GPIO_WriteBit(GPIOA, DC_Pin, (BitAction)(x))
#define OLED_W_CS(x)		GPIO_WriteBit(GPIOA, CS_Pin, (BitAction)(x))
